...
HD_PWD='H:/PUF/PUF_manualPR/PUF_manualPR.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log four_bit_puf.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source four_bit_puf.tcl -notrace
