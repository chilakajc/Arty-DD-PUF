...
HD_PWD='H:/PUF/PUF_manualPR/PUF_manualPR.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log four_bit_puf.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source four_bit_puf.tcl
